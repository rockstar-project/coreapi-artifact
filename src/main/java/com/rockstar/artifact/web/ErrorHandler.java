...
public class ErrorHandler {
	...
	public @ResponseBody ErrorResource handleInvalidSchema(InvalidSchemaException invalidschemaex) {
		ErrorResource error = new ErrorResource();
		error.setError("invalid_schema");
		error.setDescription(invalidschemaex.getMessage());
		return error;
	}
	...
	public @ResponseBody ErrorResource handleNotValid(MethodArgumentNotValidException notvalidex) {
		...
		error.setDescription(notvalidex.getMessage());
