...
@SpringBootTest
public class RestApiOpenApiJavaSpringbootCreateArtifactTest {
	...
	public void createArtifactTest() throws Exception {
		...
		SelectedValue monitoringOption = new SelectedValue();
		monitoringOption.setValue("prometheus");
		monitoringOption.setVersion("0.1.0");
		...
		artifact.setMonitoring(monitoringOption);
